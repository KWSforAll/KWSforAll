    ...
    let Pgg = setInterval(() => {
        ...
        class kwsv3 {
            constructor(charactersManager) {
                ...
                this.addToCSS(`.qtrack { width: 410px; font-size: 10px; } .qtrack strong { font-size: 10px; } #drag_con.scroll .qtrack{width:383px;} #quest_track_con #drag_tracker{user-select:none;} #quest_track_con .sep2{height:14px;} #quest_track_con .sep3{height:14px;}`);
